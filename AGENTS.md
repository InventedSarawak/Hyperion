...
- **`ghost` (Go):** The AI sidecar / CTF Copilot. Connects to the Vector DB and Local LLM for exploit generation. _(Parked — not built until later; see docs/TODO.md v5.)_
